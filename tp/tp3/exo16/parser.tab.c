...
yyreduce:
  ...
  case 2: /* S: E  */
#line 20 "parser.y"
     { printf("Réduction: S -> E  Fin!!\n\nRésultat: %d\n\n",yyval); }
#line 1071 "parser.tab.c"
    break;

  case 3: /* E: E '+' T  */
#line 23 "parser.y"
           { yyval = calculate(yyvsp[-2], '+', yyvsp[0]); printf("Réduction: E -> E + T\n"); }
#line 1077 "parser.tab.c"
    break;

  case 4: /* E: T  */
#line 24 "parser.y"
      { yyval = yyvsp[0]; printf("Réduction: E -> T\t\t$1=%d\t$$=%d\n", yyvsp[0], yyval); }
#line 1083 "parser.tab.c"
    break;

  case 5: /* T: T '*' F  */
#line 27 "parser.y"
           { yyval = calculate(yyvsp[-2], '*', yyvsp[0]); printf("Réduction: T -> T * F\n"); }
#line 1089 "parser.tab.c"
    break;

  case 6: /* T: F  */
#line 28 "parser.y"
      { yyval = yyvsp[0]; printf("Réduction: T -> F\t\t$1=%d\t$$=%d\n", yyvsp[0], yyval); }
#line 1095 "parser.tab.c"
    break;

  case 7: /* F: INTEGER  */
#line 31 "parser.y"
           { yyval = yyvsp[0]; printf("Réduction: F -> int \t\t$1=%d\t$$=%d\n", yyvsp[0], yyval); }
